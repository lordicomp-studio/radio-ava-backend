        ...
        <main class="pt-6">
            <ul class="relative">
                ...
                <li class="contents" v-for="(item,index) in store.tableData.data" :key="index"
                    ...
                    <TablePicturedItem :pictureUrl="item.downloadable?.cover?.url" link="" :text="item.downloadable?.name" />
...
import {useDownloadRecordsStore} from "../../../Stores/admin/DownloadRecords/IndexStore";
...
export default {
    ...
    setup(props){
        ...
        const store = useDownloadRecordsStore();
