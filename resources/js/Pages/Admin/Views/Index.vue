        ...
        <main class="pt-6">
            <ul class="relative">
                ...
                <li class="contents" v-for="(item,index) in store.tableData.data" :key="index"
                    ...
                    <TablePicturedItem :pictureUrl="item.viewable?.cover?.url" link=""
                                       :text="item.viewable?.title ? item.viewable?.title : item.viewable?.name" />
...
import {useViewsStore} from "../../../Stores/admin/Views/IndexStore";
